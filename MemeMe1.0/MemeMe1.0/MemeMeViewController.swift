...
//  MemeMe1.0
//
//  Created by Nora al-mansour on 3/28/1440 AH.
...
class MemeMeViewController: UIViewController, UINavigationControllerDelegate {
    ...
    func saveMeme() {
        let meme = MemeObject(topText: topTextField.text!, bottomText: bottomTextField.text!, originalImage: imageView.image!, memedImage: generateMeme())
